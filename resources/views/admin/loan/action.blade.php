<div class="flex align-items-center">
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Edit Loan"
        href="{{ route('admin.loan.edit', $id) }}">
    ...
    <?php
    $message = __('global-message.delete_alert', ['form' => __('loan')]);
    ?>
    <a class="btn btn-sm btn-icon btn-danger"
        ...
        data-bs-toggle="tooltip" title="Delete Loan" href="#">
        <span class="btn-inner">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                stroke="currentColor">
                <path
    ...
    <form action="{{ route('admin.loan.destroy', $id) }}" id="delete-form-{{ $id }}" method="post">
        @method('delete')
        @csrf()
    </form>
</div>
